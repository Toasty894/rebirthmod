...
public class PassionFruitJuiceItem extends Item {
    public PassionFruitJuiceItem(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("tooltip.rebirthmod.passion_fruit_juice").formatted(Formatting.GOLD));
        } else {
