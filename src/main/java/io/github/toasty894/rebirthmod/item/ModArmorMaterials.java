...
public enum ModArmorMaterials implements ArmorMaterial {
    PITCHBLENDE_INGOT("pitchblende", 24, new int[] {3, 7, 5, 3}, 16,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2.0f, 0.2f, () -> Ingredient.ofItems(ModItems.PITCHBLENDE_INGOT));
    ...
    public String getName() {
        return RebirthMod.MOD_ID + ":" + this.name;
    }
